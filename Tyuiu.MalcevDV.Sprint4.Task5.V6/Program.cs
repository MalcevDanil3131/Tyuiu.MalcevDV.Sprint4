using Tyuiu.MalcevDV.Sprint4.Task5.V6.Lib;
...
PrintCenteredLine("Написать программу, меняющую положительные значения массива на 1", width);
Console.WriteLine(new string('*', width));
